...
const MyAccount = () => {
    return (
        <div className="h-full w-full">
            <div className="flex w-full flex-row items-center gap-6 rounded-t-lg bg-gray-400 p-8">
                <img
                ...
                <div className="flex w-full flex-col gap-2 text-white">
                    <div className="flex flex-row items-center gap-3">
                        <span className="line-clamp-1 w-[50%] text-2xl font-semibold capitalize">
                            Lorem ipsum dolor sit, amet consectetur adipisicing
                            elit. Dolor sapiente in expedita animi. Reiciendis,
                            id! Fugit fugiat unde corporis quae iusto, modi
                            nobis perspiciatis eaque cumque veritatis quos?
                    ...
                    <div className="flex flex-row items-center gap-2 capitalize">
                        ...
                        <span>spesialisasi memakan martabat</span>
                    </div>
                </div>
                <PrimaryButton>
                    bagikan
