import MyAccountDesc from '@/Components/Account/MyAccountDesc';
import FileFixed from '@/Components/FileFixed';
...
export default function UserPreview() {
    return (
        <GuestLayout className="h-auto">
            <div className="shadow-5xl my-14 flex w-full max-w-4xl flex-col gap-6 rounded-2xl bg-white">
                <div className="h-full">
                    <div className="m flex w-full flex-row items-center gap-6 rounded-t-lg bg-gray-400 p-8 sm:flex-col md:flex-row lg:flex-row">
                        ...
                        ></img>
                        <div className="flex w-full flex-col gap-6 text-white sm:items-center md:items-start">
                    ...
                    <div className="flex w-full flex-col gap-6 p-8">
                        ...
                        <MyAccountDesc
                            title="resume"
                            className="flex w-full flex-row gap-6 overflow-x-scroll pb-3 scrollbar-none"
                        >
                            <FileFixed></FileFixed>
                        </MyAccountDesc>
                        <MyAccountDesc
                ...
                <div className="mx-6 mb-6 flex flex-col gap-2">
                    ...
                    <PrimaryButton className="w-full bg-red-500 py-4 text-lg font-semibold uppercase text-white hover:bg-red-400 focus:ring-transparent">
                        tolak
                    </PrimaryButton>
                </div>
            </div>
